...
function UserInbox({ darkMode, setDarkMode, language, setLanguage, userProfile }) {
  const [messages, setMessages] = useState([]);

  useEffect(() => {
    fetch(`https://buddymate.onrender.com/inbox/${userProfile.username}`)
      .then(res => res.json())
  ...
  return (
    <ThemeProvider theme={theme}>
      <Header darkMode={darkMode} setDarkMode={setDarkMode} language={language} setLanguage={setLanguage} isLoggedIn={true} userProfile={userProfile} isBuddy={false} />
